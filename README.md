...
- The training dataset is generated in **data.py**. Each 'image' is an 8x8 NumPy array, and will belong to a one of these types: "horizontal line", "vertical line", "blank". A blank image consists of only 0s, whereas horizontal and vertical lines are 1s.
